...
void ApplicationFunctionSet::ApplicationFunctionSet_Init(void)
{
  ...
  uint16_t intersectionCounter = 0;
...
//     }
// #endif
//     ////if the car is at a 4 way intersection, this is for driving straight through
//     // if(
//     //   function_xxx(TrackingData_L, TrackingDetection_S, TrackingDetection_E) &&
//     //   function_xxx(TrackingData_M, TrackingDetection_S, TrackingDetection_E) &&
//     //   function_xxx(TrackingData_R, TrackingDetection_S, TrackingDetection_E)
//     // )
//     // {
//     //   // All three sensors are detecting black (4-way intersection)
//     //   // Step 1: Move forward slightly
//     //   ApplicationFunctionSet_SmartRobotCarMotionControl(Forward, 100);
//     //   delay(50); // Adjust based on how far you want it to roll forward
//     //   ApplicationFunctionSet_SmartRobotCarMotionControl(stop_it, 0);
//     //   delay(100);
//     //   // Step 2: Sweep left until left sensor no longer sees black
//     //   while (function_xxx(TrackingData_L, TrackingDetection_S, TrackingDetection_E)) {
//     //     ApplicationFunctionSet_SmartRobotCarMotionControl(Left, 100);
//     //     ApplicationFunctionSet::ApplicationFunctionSet_SensorDataUpdate();
//     //     delay(10);
//     //   }
//     //   ApplicationFunctionSet_SmartRobotCarMotionControl(stop_it, 0);
//     //   delay(100);
//     //   // Step 3: Sweep right until right sensor no longer sees black
//     //   while (function_xxx(TrackingData_R, TrackingDetection_S, TrackingDetection_E)) {
...
//     // )
//     // {
//     //   // Step 1: Pull forward a bit
//     //   ApplicationFunctionSet_SmartRobotCarMotionControl(Forward, 10);
//     //   delay(200); // adjust to match your setup
//     //   ApplicationFunctionSet_SmartRobotCarMotionControl(stop_it, 0);
//     //   delay(100);

//     //   // Step 2: Sweep right slowly until line is found again on middle or left
//     //   while (
//     //     !function_xxx(TrackingData_M, TrackingDetection_S, TrackingDetection_E) &&
//     //     !function_xxx(TrackingData_L, TrackingDetection_S, TrackingDetection_E)
//     //   ) 
...
//     //   // Step 2: Sweep left slowly until line is found again on middle or right
//     //   while (
//     //     !function_xxx(TrackingData_M, TrackingDetection_S, TrackingDetection_E) &&
//     //     !function_xxx(TrackingData_R, TrackingDetection_S, TrackingDetection_E)
//     //   ) {
...
//     {
//       /*Turn left*/
//       ApplicationFunctionSet_SmartRobotCarMotionControl(Left, 90);
//       timestamp = true;
//       BlindDetection = true;
//     }
...
//     {
//       if(seekCounter == 0 || seekCounter == 1 || seekCounter == 3 || seekCounter == 4)
//       {
...
//         {
//           ////Switching Right and left to sweep the other direction
//           ApplicationFunctionSet_SmartRobotCarMotionControl(Left, 100);
//         }
...
// void ApplicationFunctionSet::SoftTurnLeft(uint8_t baseSpeed)
// {
//   // Simulate soft turn by slowing down the left turn
//   ApplicationFunctionSet_SmartRobotCarMotionControl(Left, baseSpeed * 0.7); // reduced speed
// }

// void ApplicationFunctionSet::SoftTurnRight(uint8_t baseSpeed)
// {
//   // Simulate soft turn by slowing down the right turn
//   ApplicationFunctionSet_SmartRobotCarMotionControl(Right, baseSpeed * 0.7); // reduced speed
// }
...
//   bool L = function_xxx(TrackingData_L, TrackingDetection_S, TrackingDetection_E);
//   bool M = function_xxx(TrackingData_M, TrackingDetection_S, TrackingDetection_E);
//   bool R = function_xxx(TrackingData_R, TrackingDetection_S, TrackingDetection_E);

//   // === Trigger Blind Detection ===
//   if (!L && !M && !R && timestamp)
//   {
//     timestamp = false;
//     MotorRL_time = millis();
...
//   // === Blind Detection: Always Sweep Left First, Then Right ===
//   if (!L && !M && !R && !timestamp)
//   {
//     if(seekDetection == 0 || seekDetection == 2 || seekDetection == 3) 
//     {
//       if (function_xxx((millis() - MotorRL_time), 0, 2500) && BlindDetection)
//       {
//         ApplicationFunctionSet_SmartRobotCarMotionControl(Left, 100);
//       }
//       else if (function_xxx((millis() - MotorRL_time), 2500, 5000) && BlindDetection)
//       {
//         ApplicationFunctionSet_SmartRobotCarMotionControl(Right, 100);
//       }
//       else if (function_xxx((millis() - MotorRL_time), 5000, 5500))
//       {
//         BlindDetection = false;
//         ApplicationFunctionSet_SmartRobotCarMotionControl(stop_it, 0);
//       }
//       else if (!timestamp && !BlindDetection)
//       {
//         BlindDetection = true;
//         timestamp = true;
//         MotorRL_time = 0;
...
//   // === Reset Blind Detection if Any Sensor Sees the Line Again ===
//   if (L || M || R)
//   {
//     timestamp = true;
//     BlindDetection = true;
...
//   // === All Sensors on Line (Intersection or Endpoint) ===
//   if (L && M && R)
//   {
...
void ApplicationFunctionSet::ApplicationFunctionSet_Tracking(void)
{
  ...
  static bool BlindDetection = true;
  static unsigned long MotorRL_time = 0;
  static int seekStep = 0;  // Now used as the intersection counter

  const int TrackingDetection_S = 50;
  const int TrackingDetection_E = 800;
  ...
  // === Detect and respond to intersections ===
  if (L && M && R)
  {
    ApplicationFunctionSet_SmartRobotCarMotionControl(stop_it, 0);
    ...
    {
      // Default case after step 3 — just go forward
      ApplicationFunctionSet_SmartRobotCarMotionControl(Right, 100);
      delay(300);
    }
  ...
  // === Fall-back: all sensors off line → stop
  if (!L && !M && !R)
  {
    ApplicationFunctionSet_SmartRobotCarMotionControl(stop_it, 0);
    timestamp = true;
  ...
  if (true == IRrecv_en)
  {
    ...
    case /* constant-expression */ 10:
      /* code */ if (Application_SmartRobotCarxxx0.Functional_Mode == TraceBased_mode)
      {
        ...
        TrackingDetection_S = 180;
        TrackingDetection_E = 800;
      }
      break;
